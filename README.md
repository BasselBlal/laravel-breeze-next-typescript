# Laravel Breeze - Next.js v15 Edition with TypeScript 🏝️
...
Laravel Breeze Next.js v15 is open-sourced software licensed under the [MIT license](LICENSE.md).
